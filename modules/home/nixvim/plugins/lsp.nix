  ...
  programs.nixvim = {
    ...
    plugins = {
      ...
      nvim-autopairs = {
        ...
        # Change checkTs to settings.check_ts
        settings = {
      ...
      conform-nvim = {
        ...
        # Use settings.format_on_save instead of formatOnSave
        settings = {
          format_on_save = {
            enable = true;
            lsp_fallback = true;
      ...
      friendly-snippets = {
        enable =
          true; # Adds a collection of useful snippets for various languages
      };
      ...
      cmp-dap.enable =
        true; # Provides completions in Debug Adapter Protocol windows
      cmp-nvim-lsp.enable = true; # LSP completions
      cmp-nvim-lsp-document-symbol.enable = true; # Document symbols from LSP
      cmp-nvim-lsp-signature-help.enable =
        true; # Function signature help from LSP
      ...
      lspkind = {
        ...
        # Direct configuration options (not under settings)
        mode = "symbol_text"; # Show both symbols and text
        preset = "codicons"; # Use codicons preset for symbols

        # Integration with nvim-cmp
        cmp = {
          enable = true; # Enable integration with nvim-cmp
      ...
      lsp = {
        ...
        keymaps = {
          silent =
            true; # Execute all keybindings silently (no command line echo)
        ...
        # Use postConfig to configure diagnostics after LSP is loaded
        postConfig = ''
